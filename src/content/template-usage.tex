...
Eredményként annyit tapasztalunk, hogy megint használhatóvá válik a projekt és \aref{fig:run_gamma_result} ábrán látható folyamatokból a megfelelő eltűnik.
